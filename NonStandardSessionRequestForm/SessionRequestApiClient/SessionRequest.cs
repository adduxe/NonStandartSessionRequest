...
namespace SessionRequestApi.Client
{
    ...
    public partial class SessionRequest : IServiceOperations<RNRSessionRequestAPI>, ISessionRequest
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> PostBySessionDTOWithHttpMessagesAsync(Session sessionDTO, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (sessionDTO == null)
            {
