...
namespace PeApi
{
    ...
    public partial interface ICertifiedStudents
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<object>> PostWithHttpMessagesAsync(IList<USCPEApiDTOAdvisementCertifiedStudent> students, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
