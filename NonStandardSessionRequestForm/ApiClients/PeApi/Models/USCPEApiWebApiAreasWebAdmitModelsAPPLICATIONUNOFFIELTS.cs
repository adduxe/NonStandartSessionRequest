...
namespace PeApi.Models
{
    ...
    public partial class USCPEApiWebApiAreasWebAdmitModelsAPPLICATIONUNOFFIELTS
    {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "ieltS_DATE")]
        public string IeltSDATE { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "readinG_SCORE")]
        public string ReadinGSCORE { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "writinG_SCORE")]
        public string WritinGSCORE { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "listeninG_SCORE")]
        public string ListeninGSCORE { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "speakinG_SCORE")]
        public string SpeakinGSCORE { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "overalL_BAND_SCORE")]
