...
namespace PeApi
{
    ...
    public partial interface ICountries
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<object>> Get1WithHttpMessagesAsync(string isoCode, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
