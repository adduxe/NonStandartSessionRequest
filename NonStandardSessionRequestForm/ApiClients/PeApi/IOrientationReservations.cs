...
namespace PeApi
{
    ...
    public partial interface IOrientationReservations
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<object>> PostWithHttpMessagesAsync(IList<USCPEApiDTOAdvisementOrientationReservation> reservations, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
