...
namespace PeApi
{
    ...
    public static partial class UscSchoolsExtensions
    {
            ...
            /// </param>
            public static async Task<object> GetAsync(this IUscSchools operations, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> Get1Async(this IUscSchools operations, string code, CancellationToken cancellationToken = default(CancellationToken))
            {
