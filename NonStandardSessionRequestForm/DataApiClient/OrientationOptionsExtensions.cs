...
namespace DataApiClient
{
    ...
    public static partial class OrientationOptionsExtensions
    {
            ...
            {
                return Task.Factory.StartNew(s => ((IOrientationOptions)s).GetAsync(), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            {
                return Task.Factory.StartNew(s => ((IOrientationOptions)s).GetByCodeAsync(code), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
